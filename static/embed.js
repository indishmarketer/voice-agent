...
(function () {
  ...
  style.textContent = [
    ...
    "#va-embed-btn{width:56px;height:56px;border-radius:50%;background:#0a0a0a;",
    ...
    "background:rgba(10,10,10,.85);padding:3px 9px;border-radius:99px;",
    "white-space:nowrap;max-width:120px;overflow:hidden;text-overflow:ellipsis;",
    "pointer-events:none;}",
    "#va-embed-overlay{position:fixed;inset:0;background:rgba(10,10,10,.55);",
    ...
    "box-shadow:none;background:#0a0a0a;}",
